...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference("Salary.count") do
      post salaries_url, params: { salary: { basic: @salary.basic, da: @salary.da, hra: @salary.hra, pf: @salary.pf, total: @salary.total } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { basic: @salary.basic, da: @salary.da, hra: @salary.hra, pf: @salary.pf, total: @salary.total } }
